                    ...
                    <div id="masthead" class="header-main hide-for-sticky">
                        <div class="header-inner flex-row container logo-left medium-logo-center" role="navigation">
                            <div id="logo" class="flex-col logo">
                                <a href="admin.php" title="Gấu bông siêu đẹp "
                                   rel="home">
                                ...
                                <section>
                                    <div class="noi-dung">
                                            ...
                                            while ($roww = $results->fetch_assoc()) {
                                                    ...
                                                    <form action="#" method="post" enctype="multipart/form-data">
                                                        <div class="input-form">
                                                            ...
                                                            <input type="text" class="Product_id" value="<?php echo $roww['Product_id'] ?>" name="product_id" disabled="">
                                                        </div>
                                                        <div class="input-form">
                                                            <span>Tên sản phẩm</span>
                                                            <input type="text" class="Product_name" name="product_name" value="<?php echo $roww['Product_name'] ?>" name="product_id">
                                                        </div>
                                                        <div class="input-form">
                                                            <span>Loại</span>
                                                            <select name="type">
                                                        ...
                                                        <div class="input-form">
                                                            <span>Số lượng</span>
                                                            <input type="number" class="count" name="count" min="0" value="<?php echo $roww['Count'] ?>" name="product_id">
                                                        </div>
                                                        <div class="input-form">
                                                            <span>Giá</span>
                                                            <input type="text" class="price" name="price" value="<?php echo $roww['Price'] ?>" name="Price">
                                                        </div>
                                                        <div class="input-form">
                                        ...
                                        if (isset($_POST['submit'])) {
                                            ...
                                            require_once './Connett.php';
                                            require_once './Product.php';
                                            $caller = new Product("", $product_name, $type, $count, $price, "", "","", "");
                                            $caller->edit($conn);
