...
<html lang="vi" class="loading-site no-js">
                        ...
                        <div id="masthead" class="header-main hide-for-sticky">
                            <div class="header-inner flex-row container logo-left medium-logo-center" role="navigation">
                                <div id="logo" class="flex-col logo">
                                    <a href="admin.php" title="Gấu bông siêu đẹp - Một trang web mới sử dụng "
                                       rel="home">
                                        ...
                                        <div class="container_center_body">
                                            <table>
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    if ($row['Status'] == "true") {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $row['End_end']; ?></td> 
                                                            <td><?php echo $row['Discount'] ?></td>                                                       
                                                            <td><a href="edit_event.php?edit=<?php echo $row['ID']; ?>">Sửa</a></td>
                                                            <td><a href="admin.php?delete=<?php echo $row['ID']; ?>">Xoá</a></td>
                                                        </tr>
                                                        <?php
                                                    }
                                                }
                                                ...
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td></td>
                                                    <td><a href="addevent.php"><h3>Thêm</h3></a></td>
                                                </tr>
                                            </table>
                                            <?php
            ...
            <div id="main-menu" class="mobile-sidebar no-scrollbar mfp-hide">
                <div class="sidebar-menu no-scrollbar ">
                    <ul class="nav nav-sidebar nav-vertical nav-uppercase">
                        ...
                        <li id="menu-item-584"
                            class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-584">
                            <a href="donhang.php" class="nav-top-link">Đơn hàng</a></li>
                        <li id="menu-item-585"
                            class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-585">
                            <a href="./managecustomer.php" class="nav-top-link">Quản lý khách hàng</a>
                        </li>
                        <li id="menu-item-586"
                            class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-586">
                            <a href="donhang_xatnhan.php" class="nav-top-link">Đơn hàng chờ xát nhận</a></li>                              
        ...
        <div class="sidebar-menu no-scrollbar ">
            <ul class="nav nav-sidebar nav-vertical nav-uppercase">
                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-50"><a
                        href="./manageproduct.php">Sự kiện</a></li>
    ...
    <script type='text/javascript' id='contact-form-7-js-extra'>
        var wpcf7 = {
            "apiSettings": {
                "root": "http:\/\/gaubong.giaodienwebmau.com\/wp-json\/contact-form-7\/v1",
    ...
    <script type='text/javascript' id='wc-add-to-cart-js-extra'>
        var wc_add_to_cart_params = {
            ...
            "cart_url": "http:\/\/gaubong.giaodienwebmau.com\/gio-hang\/",
            "is_cart": "",
    ...
    <script type='text/javascript' id='zxcvbn-async-js-extra'>
        var _zxcvbnSettings = {
            "src": "http:\/\/gaubong.giaodienwebmau.com\/includes\/js\/zxcvbn.min.js"
        };
    </script>
