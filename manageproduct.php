...
<html lang="vi" class="loading-site no-js">
    ...
    <body
        class="archive post-type-archive post-type-archive-product theme-flatsome woocommerce woocommerce-page woocommerce-no-js lightbox nav-dropdown-has-arrow">
        <div id="wrapper">
                    ...
                    <div id="masthead" class="header-main hide-for-sticky">
                        <div class="header-inner flex-row container logo-left medium-logo-center" role="navigation">
                            <div id="logo" class="flex-col logo">
                                <a href="./admin.php" title="Gấu bông siêu đẹp - Một trang web mới của TPBSHOP"
                                   rel="home">
                                    ...
                                    <div class="container_center_body">
                                        <table>
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                if ($row['Startus'] == "true") {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo '<img src="' . $row['Image'] . '"/ style="width:40rem;padding:1rem ">'; ?></td>
                                                        <td><?php echo $row['Date']; ?></td>
                                                        <td><?php echo $row['Description']; ?></td> 
                                                        <td><a href="editproduct.php?edit=<?php echo $row['Product_id']; ?>">Sửa</a></td>
                                                        <td><a href="manageproduct.php?delete=<?php echo $row['Product_id']; ?>">Xoá</a></td>
                                                    </tr>
                                                    <?php
                                                }
                                            }
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td><a href="addproduct.php"><h3>Thêm</h3></a></td>
                                            </tr>
                                        </table>
                                        <?php
