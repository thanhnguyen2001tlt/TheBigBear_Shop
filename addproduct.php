...
<html lang="vi" class="loading-site no-js">
    ...
    <body
                    ...
                    <div id="masthead" class="header-main hide-for-sticky">
                        <div class="header-inner flex-row container logo-left medium-logo-center" role="navigation">
                            <div id="logo" class="flex-col logo">
                                <a href="admin.php" title="Gấu bông siêu đẹp - Một trang web mới Của TBP.Shop"
                                   rel="home">
                            ...
                            <div class="flex-col hide-for-medium flex-center">
                                <ul class="nav header-nav header-bottom-nav nav-center  nav-spacing-xlarge nav-uppercase">
                                    ...
                                    <li id="menu-item-583"
                                        ...
                                        <a href="manageproduct.php" class="nav-top-link">Sản Phẩm</a></li>
                                    <li id="menu-item-584"
                        ...
                        <div class="shop-container">
                            <div class="woocommerce-notices-wrapper">
                                        ...
                                        <div class="form">
                                            ...
                                            <form action="#" method="post" enctype="multipart/form-data">
                                                <div class="input-form">
                                                    ...
                                                    <input type="text" class="Product_id" name="product_id" required="">
                                                </div>
                                                <div class="input-form">
                                                    <span>Tên sản phẩm</span>
                                                    <input type="text" class="Product_name" name="product_name" required="">
                                                </div>
                                                <div class="input-form">
                                                    <span>Loại</span>
                                                    <select name="type" >
                                                ...
                                                <div class="input-form">
                                                    <span>Số lượng</span>
                                                    <input type="number" class="count" name="count" min="0" required="">
                                                </div>
                                                <div class="input-form">
                                                    <span>Giá</span>
                                                    <input type="text" class="price" name="price" required="">
                                                </div>
                                                <div class="input-form">
                                                    <span>Ảnh</span>
                                                ...
                                                <div class="input-form">
                                                    <span>Ảnh mô tả</span>
                                                    <input type="file" class="img" name="images[]" multiple="multiple"required="">
                                                </div>
                                                <div class="input-form">
                                                    <span>Ngày</span>
                                                ...
                                                <div class="input-form">
                                                    <span>Mô tả</span>
                                                    <textarea id="description" name="description" cols="8" required="" >
                                                    </textarea>
                                                </div>
                                                <div class="input-form">
                                                    <input type="submit" value="Thêm sản phẩm" name="submit" required="">
                                                </div>
                                                <div class="input-form">
                                                    <a href="manageproduct.php">Xem sản phẩm</a>
                                                </div>
                                        </div>
                                </section>
                                <?php
                                if (isset($_POST['submit'])) {
                                    ...
                                    $call->uploadfile();
                                    $call->uploadfileimg();
                                    $caller = new Product($product_id, $product_name, $type, $count, $price, $image, "true", $date, $description);
                                    $kt = $caller->insert($conn);
                                    $file_name = $_FILES["images"]['name'];
                                    foreach ($file_name as $key => $value) {
                                        $img = $target_dir . $_FILES["images"]['name'][$key];
                                        $sql = "insert into image(Product_id,file) values (?,?)";
                                        $stmt = $conn->prepare($sql);
                                        $stmt->bind_param("ss", $product_id, $img);
                                        $stmt->execute();
                                    }
                                }
                                ?>
        ...
        <script type='text/javascript'src='content/plugins/woocommerce/assets/js/jquery-blockui/jquery.blockUI.min44fd.js?ver=2.70'
    ...
    <script type='text/javascript' id='wp-polyfill-js-after'>
                    ...
                    (Element.prototype.matches && Element.prototype.closest) || document.write(
                            '<script src="includes/js/dist/vendor/wp-polyfill-element-closest.min4c56.js?ver=2.0.2"></scr' + 'ipt>');
    </script>
