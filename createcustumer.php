                    ...
                    <div id="masthead" class="header-main hide-for-sticky">
                        <div class="header-inner flex-row container logo-left medium-logo-center" role="navigation">
                            <div id="logo" class="flex-col logo">
                                <a href="Dangnhap.php" title="Gấu bông siêu đẹp - Một trang web mới Của TBP.Shop"
                                   rel="home">
                                    ...
                                    <li class="header-search-form search-form html relative has-icon">
                                        <div class="header-search-form-wrapper">
                                            <div class="searchform-wrapper ux-search-box relative is-normal">
                                                <form role="search" method="post" class="searchform" action="./index.html">
                            ...
                            <div class="flex-col hide-for-medium flex-right">
                                <ul class="header-nav header-nav-main nav nav-right  nav-uppercase">
                                    <li id="dangxuat" style="display: block;" title="ADMIN">
                                        <img src="admin/images/avata.png" alt="" srcset="" id="avatar">		
                                        <a href="Dangnhap.php">
                                            <span id="Đăng xuất">
                                                Đăng Xuất
                                            </span>
                            ...
                            <div class="flex-col show-for-medium flex-right">
                                <ul class="mobile-nav nav nav-right ">
                                    <li class="cart-item has-icon" title="ADMIN">
                                        <a href="#"
                                        ...
                                        <div id="cart-popup" class="mfp-hide widget_shopping_cart">
                                            <div class="cart-popup-inner inner-padding">
                                                <div class="cart-popup-title text-center">
                                                    <a href="Dangnhap.php"><h4 class="uppercase">Đăng Xuất</h4></a>
                        ...
                        <div class="shop-container">
                            <div class="woocommerce-notices-wrapper">
                                        ...
                                        <div class="form">
                                            ...
                                            <form action="#" method="post">
                                                <div class="input-form">
                                                    <span>Họ và tên</span>
                                                    <input  value="" type="text" name="fullname"  required title="Vui lòng nhập họ và tên">
                                                </div>
                                                <div class="input-form">
                                                    <span>Tên Người Dùng</span>
                                                    <input  value="" type="text" name="name" pattern="[A-Za-z0-9]{5,30}" title="Sử dụng Tên không có ký tự đặc biệt hoặc khoảng trống" required>
                                                </div>
                                                <div class="input-form">
                                                    <span>Mật Khẩu</span>
                                                    <input  value="" type="password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"  title="Phải chứa ít nhất một số và một chữ cái viết hoa và viết thường và ít nhất 8 ký tự" required> 
                                                </div>
                                                <div class="input-form">
                                                    <span>Điện Thoại</span>
                                                    <input  value="" type="text" name="phone" pattern="[0]{1}[1-9]{1}[0-9]{8,9}" title="Vui lòng Nhập đúng Số điện thoại" required>
                                                </div>
                                                <div class="input-form">
                                                    <span>email</span>
                                                    <input  value="" type="email" name="email" title="Vui lòng nhập Email" required>
                                                </div>
                                                <div class="input-form">
                                                    <span>Địa chỉ</span>
                                                    <input  value="" type="text" name="diachi" title="Nhập địa chỉ" required>
                                                </div>
                                                <div class="dieukhoan">
                                                    <label><input type="checkbox" name="dieukhoan" title="Vui lòng nhập vào điều khoảng" required> Đồng ý điều khoản <a href="http://">Điều khoản của chúng tôi</a></label>
                                                </div>
                                                <div class="input-form">
                                ...
                                if (isset($_POST["submit"])) {
                                    ...
                                    $point = "0";
                                    $img = "images/user.png";
                                    $call = new Account($name, $fullname, $name, $password, $phone, $email, $diachi,$status, $point,$img);
                                    $call->insert($conn);
                                    echo "<script>alert('Tạo thành công');</script>";
                                    echo "<meta http-equiv=\"refresh\" content=\"0;URL=managecustomer.php\">";
                                }
                                ?>
                            </div>	
                        </div>
