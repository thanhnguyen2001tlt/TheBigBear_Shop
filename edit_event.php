...
<html lang="vi" class="loading-site no-js">
    ...
    <head>
        ...
        <link rel='shortlink' href='admin.php' />
        <style>
        </style>
                                        ...
                                        <li class="header-search-form search-form html relative has-icon">
                                            <div class="header-search-form-wrapper">
                                                <div class="searchform-wrapper ux-search-box relative is-normal">
                                                    <form role="search" method="post" class="searchform" action="admin.php">
                                            ...
                                            <div id="cart-popup" class="mfp-hide widget_shopping_cart">
                                                <div class="cart-popup-inner inner-padding">
                                                    <div class="cart-popup-title text-center">
                                                        <a href=""><h4 class="uppercase">Đăng Xuất</h4></a>
                            ...
                            <div class="shop-container">
                                <div class="woocommerce-notices-wrapper">
                                                ...
                                                while ($roww = $results->fetch_assoc()) {
                                                    ...
                                                    <form action="#" method="post" enctype="multipart/form-data">
                                                        <div class="input-form">
                                                            ...
                                                            <input type="text" class="Product_id" name="event_id" required="" value="<?php echo $roww['ID'] ?>" readonly="">
                                                        </div>
                                                        <div class="input-form">
                                                            <span>Tên sự kiện</span>
                                                            <input type="text" class="Product_name" name="event_name" required="" value="<?php echo $roww['Event'] ?>">
                                                        </div>

                                                        <div class="input-form">
                                                            <span>Ngày bắt đầu</span>
                                                            <input type="date" class="count" name="date_st" min="0" required="" value="<?php echo $roww['Start_date'] ?>">
                                                        </div>
                                                        <div class="input-form">
                                                            <span>Ngày kết thúc</span>
                                                            <input type="date" name="date_e" required="" value="<?php echo $roww['End_end'] ?>">
                                                        </div>
                                                        <div class="input-form">
                                                            <span>Giảm</span>
                                                            <input type="text" class="price" name="giam" required="" value="<?php echo $roww['Discount'] ?>" >
                                                        </div>
                                                        <div class="input-form">
                                                            <input type="submit" value="Cập nhật sự kiện" name="submit" required="">
                                                        </div>
                                                        <div class="input-form">
                                                            <a href="admin.php">Xem sự kiện</a>
                                                        </div>
                                                    </form>
                                                <?php } ?>
                                            </div>
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        require_once './event.php';
                                        require_once './Connett.php';
                                        $called = new event("", $event, $start, $end, $discount);
                                        $called->edit($conn);
