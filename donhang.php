                            ...
                            <div class="flex-col hide-for-medium flex-center">
                                <ul class="nav header-nav header-bottom-nav nav-center  nav-spacing-xlarge nav-uppercase">
                                    ...
                                    <li id="menu-item-586"
                                        ...
                                        <a href="donhang.php" class="nav-top-link">Đơn hàng chờ Xác nhận</a></li>                              
                                </ul>
                            </div>
                            ...
                            <div class="woocommerce-notices-wrapper">
                                <div class="container_center">
                                    ...
                                    <div class="container_center_body">
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                if ($row['Status'] == "ready") {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['ID_Product_list']; ?></td>
                                                        <td><?php echo $row['Customer_ID']; ?></td>
                                                        <td><?php echo currency_format($row['Total']); ?></td> 
                                                        <td><?php echo $row['date']; ?></td>
                                                        <td><a href="donhang.php?xatnhan=<?php echo $row['ID_Order']; ?>">Xát nhận</a></td>
                                                        <td><a href="donhang.php?huy=<?php echo $row['ID_Order']; ?>">Huỷ</a></td>
                                                    </tr>
                                                    <?php
                                                }
                                            }
                                        ...
                                        <?php
                                        if (!empty($_GET['xatnhan'])) {
                                            if ($_REQUEST["xatnhan"]and $_REQUEST['xatnhan'] != "") {
                                                require_once './order.php';
                                                require_once './Connett.php';
                                                $call = new order("", "", "", "", "", "");
                                                $call->xatnhan($conn);
                                                echo "<script>alert('Đã Xác nhận');</script>";
                                                echo "<meta http-equiv=\"refresh\" content=\"0;URL=donhang.php\">";
                                            }
                                        }
                                         if (!empty($_GET['huy'])) {
                                            if ($_REQUEST["huy"]and $_REQUEST['huy'] != "") {
                                                require_once './order.php';
                                                require_once './Connett.php';
                                                $call = new order("", "", "", "", "", "");
                                                $call->huy($conn);
                                                echo "<script>alert('Đã Huỷ');</script>";
                                                echo "<meta http-equiv=\"refresh\" content=\"0;URL=donhang.php\">";
                                            }
                                        }
                                        ?>
