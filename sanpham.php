...
<head>
    ...
    $call = new Product("", "", "", "", "", "", "", "", "");
    $resultsp = $call->seachproduct($conn);
    $rowone = $resultsp->fetch_assoc();
    ?>
    <?php
    if (isset($_GET['action']) && $_GET['action'] == "add") {
        ...
        if (isset($_SESSION['cart'][$id])) {
            ...
            if (isset($rowone['Product_id'])) {
                $_SESSION['cart'][$rowone['Product_id']] = array("name" => $rowone['Product_name'], "quantity" => 1, "price" => $rowone['Price'], "image" => $rowone['Image']);
            } else {
    ...
    <title><?php echo $rowone['Product_name']; ?></title>
...
<body>
    <div class="home page-template page-template-page-blank page-template-page-blank-php page page-id-41 theme-flatsome woocommerce-no-js lightbox nav-dropdown-has-arrow">
        <div id="wrapper">
                                                ...
                                                <div class="widget_shopping_cart_content">
                                                    ...
                                                    if (!empty($_GET['user'])) {
                                                        if ($_REQUEST["user"]and $_REQUEST['user'] != "") {
                                                            ...
                                                            echo "<meta http-equiv=\"refresh\" content=\"0;URL=sanpham.php?.\">";
                                                        }
                                                    }
                                                    ?>
                                                </div>
                    ...
                    <div class="row" id="row-513196996">
                        ...
                        <div class="product-small  has-hover box-normal box-text-bottom">
                            <div class="show">
                                ...
                                ?>
                                <div class="left">
                                    <img src="<?php echo $rowone['Image'] ?>" width="84%" id="main-img">
                                    <p>
                                        <img src="<?php echo $rowone['Image'] ?>" width="120" />
                                        <?php
                                        $result = $call->showimg($conn);
                                        while ($row = $result->fetch_assoc()) {
                                            ?>
                                            <img src="<?php echo $row['file'] ?>" width="120" />
                                        <?php } ?>
        ...
        $(() => {
            $('p img').click(function () {
                ...
                $('#main-img').attr('src', imgPath);
                                ...
                                <div class="right">
                                    <a href="./index.php">TRANG CHỦ</a> / <a href="#"><?php echo $rowone['Type'] ?></a>
                                    <h1><?php echo $rowone['Product_name'] ?></h1>
                                    <h1 id="gia" name="gia"><?php echo currency_format($rowone['Price']) ?></h1>
                                    <span >
                                        <h3>Số Lượng: <?php echo $rowone['Count'] ?></h3>
                                    </span>   
                                    <span>
                                        <h3> <?php echo $rowone['Description'] ?> </h3>
                                    </span>

                                    <?php $t = $rowone['Type'] ?>
                                    <a href="Dangnhap.php" style="display:<?php echo $dangnhap; ?>"><input type="submit" value="MUA HÀNG" style="margin-top: 50px" />  </a>
                                    <a href="sanpham.php?action=add&id=<?php echo $rowone['Product_id'] ?>" style="display:<?php echo $dangxuat; ?>"><input type="submit" value="MUA HÀNG" /></a>
                                </div>       
                            </div>
                        </div>
                    </div>
            ...
            <div class="product-footer">
                <div class="container">
                    ...
                    <div class="woocommerce-tabs wc-tabs-wrapper container tabbed-content">
                        ...
                        <div class="tab-panels">
                            <div class="woocommerce-Tabs-panel woocommerce-Tabs-panel--description panel entry-content active"
                                ...
                                <!-- mô tả-->
                                <figure id="attachment_33000" class="wp-caption aligncenter"
                                        aria-describedby="caption-attachment-33000"></figure>
                            </div>
                                        ...
                                        <div id="review_form" class="col-inner">
                                            <div class="review-form-inner has-border">
                                                <div id="respond" class="comment-respond">
                                                    <h3 id="reply-title" class="comment-reply-title">Hãy là người đầu
                                                        tiên nhận xét cho Sản phẩm; <small><a rel="nofollow"
                                                                                              id="cancel-comment-reply-link" href="index.html#respond"
                                                                                              style="display:none;">Hủy</a></small></h3>
                                                    <form action="#" method="post">
                                                        <div class="comment-form-rating"><label for="rating">Đánh giá
                                                                của bạn&nbsp;<span
                                                        ...
                                                        <p class="comment-form-comment"><label for="comment">Nhận xét
                                                                của bạn&nbsp;<span
                                                        ...
                                                        <p class="comment-form-cookies-consent"><input
                                                                ...
                                                                value="yes" /> <label
                                                                for="wp-comment-cookies-consent">Lưu tên của tôi, email,
                                                                và trang web trong trình duyệt này cho lần bình luận kế
                                                                tiếp của tôi.</label></p>
                                                        <p class="form-submit"><input name="submit" type="submit"
                                                                                      id="submit" class="submit" value="Gửi đi" /> <input
                                                                                      type='hidden' name='comment_post_ID' value='558'
                                                                                      id='comment_post_ID' />
                    ...
                    <div class="new" style="">
                        ...
                        while ($row = $result->fetch_assoc()) {
                            if ($row['Startus'] == "true" && $row['Type'] == $t) {
                                ?>
                                <a href="sanpham.php?id=<?php echo $row['Product_id']; ?>">
                                    <div class="sp" style="display: inline-block;width: 360px">
