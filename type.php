                            ...
                            <div class="flex-col show-for-medium flex-right">
                                <ul class="mobile-nav nav nav-right ">
                                    <li class="cart-item has-icon">
                                        <a href="Giohang.php" class="header-cart-link off-canvas-toggle nav-top-link is-small"
                            ...
                            <div class="row" id="row-513196996">
                                <div class="container section-title-container">
                                    <h3 class="section-title section-title-center"><b></b><span
                                            class="section-title-main" style="color:rgb(239, 141, 160);">Sản Phẩm</span><b></b></h3>
                                ...
                                <div class="product-small  has-hover box-normal box-text-bottom">
                                    <div class="show">
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            if ($row['Startus'] == "true" && preg_replace('/\s+/', '', $row['Type']) == $_GET['type']) {
                                                ?>
                                            ...
                                            <div id="col-1742909733" class="col medium-4 small-12 large-4">
                                                <div class="col-inner">
                                                    ...
                                                    <div class="video video-fit mb" style="padding-top:47%;">
                                                        <p><iframe title="Shop Gấu Bông Online ở HN" width="1020"
                                                                   height="574"
